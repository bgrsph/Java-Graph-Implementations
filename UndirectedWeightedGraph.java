...
public class UndirectedWeightedGraph<V> extends BaseGraph<V> {
	...
	private float DEFAULT_WEIGHT = Float.MIN_VALUE;
	...
	public class Edge {
		...
		public Edge(Vertex<V> end1, Vertex<V> end2, float weight) {
			this.weight = weight;
			this.end1 = end1;
			this.end2 = end2;
		}
		...
		public String toString() {
			return "(" + end1.element + "---" + end2.element + "," + weight + ")";
		}
	}
	/////////////////////// NESTED CLASSES END//////////////////////////
	...
	public void insertEdge(V source, V target, float weight) {
		//	System.out.println("System called insertEdge : " + source + "---" + target + "," + weight);
		Vertex<V> v1 = getVertex(source);
		Vertex<V> v2 = getVertex(target);
	...
	/*
	 * Removes the edge between source and vertex. CAREFUL: Adds the vertices if
	 * they are not already in the graph! This is different than most graph ADTs
	 * Returns true if it is successful Returns false if there is no such edge
	 * 
	...
	public float getEdgeWeight(V source, V target) {
		...
		if (v1 == null || v2 == null) {
			//	System.out.println("One of the vertex is null or does not exist: " + source + "," + target);
			//	System.out.println("Returning " + Float.MAX_VALUE);
			return Float.MAX_VALUE;
		} else {
			//	System.out.println("Vertexes exist ");
			//	System.out.println("Vertex List: " + vertexList);
			if (!isThereAnyEdge(v1, v2)) {
				//	System.out.println("Edge does not exist: " + source + "---" + target );
				//	System.out.println("Edge List:" + edgeList);
				//	System.out.println("Returning " + Float.MAX_VALUE);
				return Float.MAX_VALUE;
			} else {
				//	//	System.out.println("Edge does exist: " + getEdge(v1,v2) );
				//		System.out.println("Edge List:" + edgeList);
